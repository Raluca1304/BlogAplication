...
public class JwtService {
    ...
    public String generateToken(UserEntity user) {
        ...
        if (user.getRole() != null) {
            ...
            claims.put("role", "ROLE_USER"); // Default role if none specified
        }
    ...
    // Utility method to check if user has specific role from token
    ...
    // Utility method to check if user is author
    public boolean isAuthor(String token) {
        return hasRole(token, "ROLE_AUTHOR");
    }
}
